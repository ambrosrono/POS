...
<span>Gender : </span><input type="text" style="width:265px; height:30px;" name="gender" placeholder="Gender" Required/><br>
<span>Age : </span><input type="text" style="width:265px; height:30px;" name="age" placeholder="Age" Required/><br>
<span>Country: </span><input type="text" style="width:265px; height:30px;" name="country" placeholder="Country" Required/><br>
